...
const LevelScript* get_level_main_scripts_entry() {
  const LevelScript level_main_scripts_entry_before[] = {
      ...
      LOAD_MODEL_FROM_DL(MODEL_WHITE_PARTICLE_DL, white_particle_dl,
                         LAYER_ALPHA),
      LOAD_MODEL_FROM_GEO(MODEL_WHITE_PARTICLE, white_particle_geo),
      LOAD_MODEL_FROM_GEO(MODEL_YELLOW_COIN_NO_SHADOW,
      ...
      LOAD_MODEL_FROM_GEO(MODEL_MARIOS_WINGED_METAL_CAP,
  ...
  return level_main_scripts_entry;
}
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_EXCLAMATION_BOX_OUTLINE,
    ...
    LOAD_MODEL_FROM_DL(MODEL_EXCLAMATION_POINT,
                       exclamation_box_outline_seg8_dl_08025F08, LAYER_ALPHA),
    ...
    LOAD_MODEL_FROM_DL(MODEL_DL_CANNON_LID, cannon_lid_seg8_dl_080048E0,
                       LAYER_OPAQUE),
...
const LevelScript script_func_global_5[] = {
    ...
    LOAD_MODEL_FROM_DL(MODEL_DL_WHIRLPOOL, whirlpool_seg5_dl_05013CB8,
                       LAYER_TRANSPARENT),
...
const LevelScript script_func_global_7[] = {
    LOAD_MODEL_FROM_DL(MODEL_DL_MONTY_MOLE_HOLE,
